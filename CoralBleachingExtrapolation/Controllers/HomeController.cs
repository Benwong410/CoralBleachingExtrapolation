...
/// 4-3-2025    1.1              Keelin      Implement Index(Read all) and Update  
/// </summary>
...
public class HomeController : Controller
{
    ...
    public IActionResult Index() // Read
    {
        ...
        //Ben: During testing, the read all take a long run time
        //To reduce run time, I limited to only last 10 record of polygon
